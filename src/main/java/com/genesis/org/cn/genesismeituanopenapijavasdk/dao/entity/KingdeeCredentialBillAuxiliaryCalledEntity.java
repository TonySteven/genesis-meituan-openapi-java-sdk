...
/**
 * KingdeeCredentialBillAuxiliaryCalled实体类
 *
 * @author 人工智能
...
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "kingdee_credential_bill_auxiliary_called")
public class KingdeeCredentialBillAuxiliaryCalledEntity {
