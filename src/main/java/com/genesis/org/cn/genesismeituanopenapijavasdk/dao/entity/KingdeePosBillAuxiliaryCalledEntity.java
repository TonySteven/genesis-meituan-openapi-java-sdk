...
/**
 * KingdeePosBillAuxiliaryCalled实体类
 *
 * @author 人工智能
...
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "kingdee_pos_bill_auxiliary_called")
public class KingdeePosBillAuxiliaryCalledEntity {
     ...
     * jd_pos_shop_bill.no
     */
    @TableField(value = "jd_pos_shop_bill_no")
    private String jdPosShopBillNo;
